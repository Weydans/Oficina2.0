...
class OrcamentoBusca extends OrcamentoController 
{
	...
	private function exeBusca($page, $delete, $dadosForm)
	{
		...
		$ordenacao = "ORDER BY orcamento_data_hora DESC";

		if ($this->listAll === true){
			// LISTA TODOS OS ORÇAMENTOS E REALIZA PAGINAÇÃO
			$this->paginator = new Paginator('http://oficina2.0.com/busca?page=', $page, $orcamento, 6, $paramBusca);
			...
			$this->paginator = new Paginator('http://oficina2.0.com/busca?page=', $page, $orcamento, 5, $paramBusca);
